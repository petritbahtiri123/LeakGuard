Create Codex pet row `running-right` for `cipher`: exactly 8 full-body frames in one horizontal strip on flat pure magenta #FF00FF.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Compact whole-body sticker-plush privacy guardian inspired by local-first secret scanning and careful coding: soft charcoal body, teal shield-shaped chest patch, warm amber eyes, tiny laptop-keycap satchel, calm senior-engineer focus, playful but not loud. No text, no logos, no readable symbols.. Preserve silhouette, face, palette, material, proportions, markings, and props.
