...
| WhatsApp Web | `https://web.whatsapp.com/` | Verify drafts, clipboard image paste, single-file attach/drop, and in-cap multi-file sanitized attach/drop are protected without sending messages; over-cap batches block before read. |
