...
Use this checklist for WhatsApp Web PDF document support. The single-file path supports one text PDF selected from the attach button. The multi-file path supports 2-5 sanitized files for supported PDFs, text documents, DOCX files, XLSX files, and images.
