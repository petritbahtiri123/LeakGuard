...
- WhatsApp attach-button and drag/drop support for 1-5 sanitized files across canonical supported images, text-like files including `Dockerfile` and `Makefile`, PDF, DOCX, and XLSX; 6+ files block before read
