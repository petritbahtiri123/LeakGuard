...
- WhatsApp Web support includes protected text typing, multiline text, text paste, clipboard image paste for PNG/JPG/JPEG/WEBP, attach-button single file, attach-button multi-file batches, drag/drop single file, and drag/drop multi-file batches within the protected-site small/large batch caps; over-cap batches and unsupported file families block before read.
...
- unsupported files show honest unsupported/fail-closed messaging and are not marked scanned, sanitized, or protected
