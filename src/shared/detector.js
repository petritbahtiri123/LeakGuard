(function () {
  ...
  if (!root.PWM.DetectionUrlUserinfo && typeof require === "function") {
    require("./detection/urlUserinfo.js");
  }
  const {
  ...
  root.PWM.DetectionStructuredMetadataDependencies = Object.assign(
    {},
    root.PWM.DetectionStructuredMetadataDependencies,
    {
      isCleanPlaceholder,
      containsPlaceholder,
      isLikelyEmailAddress,
      isLikelyUsernameLikeValue
    }
  );
  if (!root.PWM.DetectionStructuredMetadata && typeof require === "function") {
    require("./detection/structuredMetadata.js");
  }
  const { scanStructuredMetadataRows } = root.PWM.DetectionStructuredMetadata;
  ...
  class Detector {
    ...
    scanStructuredMetadataRows(text) {
      return scanStructuredMetadataRows(text, this);
    }
