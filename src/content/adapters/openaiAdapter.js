(function () {
  ...
  function createOpenAiAdapter({ pendingAttachEnabled, hooks = {} } = {}) {
    return {
      id: "openai",
      ...
      pendingAttachEnabled: pendingAttachEnabled?.openai,
  ...
  root.PWM.SiteAdapters.createOpenAiAdapter = createOpenAiAdapter;
